...
+ (CTTextAlignment)alignmentFromNSTextAlignment:(NSTextAlignment)alignment;
...
- (void)setTextAlignment:(NSTextAlignment)textAlignment {
  ...
  if (nil != self.mutableAttributedString) {
    CTTextAlignment alignment = [self.class alignmentFromNSTextAlignment:textAlignment];
...
- (void)setLineBreakMode:(NSLineBreakMode)lineBreakMode {
  ...
  if (nil != self.mutableAttributedString) {
    CTTextAlignment alignment = [self.class alignmentFromNSTextAlignment:self.textAlignment];
...
+ (NSMutableAttributedString *)mutableAttributedStringFromLabel:(UILabel *)label {
  ...
  if (label.text.length > 0) {
    ...
    CTTextAlignment textAlignment = [self alignmentFromNSTextAlignment:label.textAlignment];
